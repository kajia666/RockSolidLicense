...
- 开发者授权快启里的 `Launch Bootstrap / First Batch Setup / Inventory Refill` follow-up 现在也会优先把 `launch-mainline summary / checksums / zip` 一起带出来，所以初始化动作做完以后，可以直接顺着统一总览 handoff 去做后续 launch review、smoke 和 ops 复查，而不是还要自己在几份材料之间来回切
