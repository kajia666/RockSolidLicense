...
- the follow-up buttons now adapt to that mitigation conclusion as well, so outcome-driven states use clearer labels such as confirming mitigation, reviewing lower risk, or returning to escalation control
