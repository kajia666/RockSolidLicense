  ...
  try {
    ...
    assert.deepEqual(output.launchDutyNextRun, {
      ...
      postArchiveEvidenceActions: [
        ...
        },
        {
          ...
          recordCommand: `npm.cmd run staging:launch-duty:record -- --closeout-input-file ${inputFile} --key first_wave_closeout --artifact-path artifacts/staging/PILOT_ALPHA/stable/first-wave-closeout.md --value-json <redacted-json> --receipt-id <record_launch_closeout_review-receipt-id> --source-record first_wave_incident_log=<first_wave_incident_log-artifact-path> --source-record rollback_signal_review=<rollback_signal_review-artifact-path> --source-record stabilization_owner_handoff=<stabilization_owner_handoff-artifact-path> --actions-file ${actionsFile}`,
          exampleCommand: `npm.cmd run staging:launch-duty:record -- --closeout-input-file ${inputFile} --key first_wave_closeout --artifact-path artifacts/staging/PILOT_ALPHA/stable/first-wave-closeout.md --value-json '{"result":"closed","unresolvedIncidents":[],"summary":"<redacted first-wave closeout summary>"}' --receipt-id <record_launch_closeout_review-receipt-id> --source-record first_wave_incident_log=<first_wave_incident_log-artifact-path> --source-record rollback_signal_review=<rollback_signal_review-artifact-path> --source-record stabilization_owner_handoff=<stabilization_owner_handoff-artifact-path> --actions-file ${actionsFile}`,
    ...
    assert.deepEqual(output.operatorNextCommands, [
      ...
      },
      {
        ...
        phase: "first_wave_closeout",
        actionKey: "close_first_wave",
        command: `npm.cmd run staging:launch-duty:record -- --closeout-input-file ${inputFile} --key first_wave_closeout --artifact-path artifacts/staging/PILOT_ALPHA/stable/first-wave-closeout.md --value-json <redacted-json> --receipt-id <record_launch_closeout_review-receipt-id> --source-record first_wave_incident_log=<first_wave_incident_log-artifact-path> --source-record rollback_signal_review=<rollback_signal_review-artifact-path> --source-record stabilization_owner_handoff=<stabilization_owner_handoff-artifact-path> --actions-file ${actionsFile}`,
        statusCommand: `npm.cmd run staging:readiness:status -- --input-file ${inputFile} --actions-file ${actionsFile}`,
    ...
    assert.match(markdown, /Handoff first-wave closeout command: `npm\.cmd run staging:launch-duty:record -- --closeout-input-file .*filled-closeout-input\.json --key first_wave_closeout --artifact-path artifacts\/staging\/PILOT_ALPHA\/stable\/first-wave-closeout\.md --value-json <redacted-json> --receipt-id <record_launch_closeout_review-receipt-id> --source-record first_wave_incident_log=<first_wave_incident_log-artifact-path> --source-record rollback_signal_review=<rollback_signal_review-artifact-path> --source-record stabilization_owner_handoff=<stabilization_owner_handoff-artifact-path> --actions-file .*readiness-action-queue\.md`/);
