...
仓库现在还提供了一个专门的产品中心页面：`/admin/products`，可直接创建开发者账号、分配项目归属并调整产品级功能开关，同时在页头汇总展示注册、账号登录、卡密登录、卡密充值、版本检查、公告和客户端解绑这 7 个项目级开关的覆盖情况。
