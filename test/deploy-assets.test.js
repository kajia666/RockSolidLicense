...
test("windows deployment guide documents server gate, prepare-local, status, operator pack, prepare pack, evidence pack, preflight, task, healthcheck, backup, and caddy flow", () => {
  const readme = readText("README.md");
  const runbook = readText("docs/production-operations-runbook.md");
