...
- 项目页发版快速信号摘要
- 项目页内联发版 readiness 预览，可按 channel 直接查看候选版本、阻断项、检查清单和下一步动作；项目页也支持同 channel 的 integration snapshot 预览，并直接下载 release `summary / checksums / zip` 以及常用 integration `env / host-config / cmake / vs2022-guide / vs2022-sln / vs2022 / vs2022-props / vs2022-local-props / host-skeleton / zip`
- 开发者多项目归属
- 开发者主账号 + 子账号
- 子账号按项目授权与角色控制
- 客户端版本规则
