...
- a VS2022 `.vcxproj` plus `RockSolidSDK.props` for software authors who prefer native Visual Studio projects
...
- `format=json|summary|env|host-config|cmake|vs2022|vs2022-props|cpp|host-skeleton|checksums|zip`
