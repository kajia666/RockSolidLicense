...
- The project-scoped integration and release packages now also emit a matching VS2022 `.sln/.vcxproj/.props` trio plus a project-aware `VS2022 quickstart` markdown guide, so software authors can start from a ready-to-open solution instead of wiring a native project by hand.
