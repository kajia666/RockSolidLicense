...
- If the software author prefers native Visual Studio projects, the generated integration and release packages now also emit a VS2022 `.vcxproj` template plus a matching `RockSolidSDK.props` sheet that points at the extracted SDK package root.
