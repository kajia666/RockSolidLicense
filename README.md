...
- 开发者授权中心现在补了 `Launch Authorization Quickstart`，会按项目当前登录模式、策略数、卡密库存、起步账号状态给出首发建议，并能一键预填 starter duration / points policy 和 starter card batch
- 开发者多项目归属
- 开发者主账号 + 子账号
- 子账号按项目授权与角色控制
- 客户端版本规则
