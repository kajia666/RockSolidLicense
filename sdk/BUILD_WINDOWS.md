...
The `rocksolid-sdk-cpp` package contains the full C++ SDK static library, headers, docs, the high-level demo source, and a host-app-oriented C++ skeleton template.
